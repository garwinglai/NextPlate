...
import { createAdditionalBiz } from "../../../actions/crud/bizUser";
...
import styles from "../../../styles/components/auth/additionalbiz/addbizreview.module.css";
...
export default function AddBizReview({
	currentStep,
	stepsArray,
	handleNext,
	handleBack,
	...
	const handleSubmit = async (e) => {
		...
		const { success, message } = await createAdditionalBiz(
			businessInfo,
			defaultProduct,
			uid,
			existingBiz
	...
	return (
		<React.Fragment>
			<div className={`${styles.AddBizReview}`}>
							...
							{loading && (
								<Grid item xs={12} md={12}>
									<Collapse in={true}>
										<Alert severity="info">
											<p>
												Don&apos;t press back while loading. May take 30
												seconds.
											</p>
										</Alert>
									</Collapse>
